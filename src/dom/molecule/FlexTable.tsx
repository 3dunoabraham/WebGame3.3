...
function Component ({ theArray, bools, config, actionCard, actionHeader }:any) {
    return (<>
        ...
        <div  className='flex-col    w-100 bord-r-8    block noverflow border-lgrey  box-shadow-1-b' >
                    ...
                    <div className="h-100 w-100 flex">
                        ...
                        <div className="flex w-70 ">
                            {config.childrenArray && config.childrenArray.map((aChildren:any, index:number)=>{
                                return (
                                    <div key={index}  className={`flex-1 flex-col px-2  ${aChildren.class}`}>
                                        {aChildren.title}
                                    </div>
                                )
                            })}
