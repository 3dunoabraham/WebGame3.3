...
import { UnitMainForm } from '@/dom/organism/ims/partials/unit/MainForm'
import UnitTopForm from '@/dom/organism/ims/partials/unit/TopForm'
import { UnitBottomForm } from '@/dom/organism/ims/partials/unit/BottomForm'
import { UnitModalsSection } from '@/dom/organism/ims/partials/unit/ModalsSection';
import { UnitSaveEditButtonLoadings } from '@/dom/organism/ims/partials/unit/SaveEditButtonLoadings';
import { fetchPost, parseChangedDataToAddObj } from '@/../script/util/helper/fetchHelper';
import { SectionPlaceholder } from '@/dom/organism/ims/items/atoms/holders/SectionPlaceholder';
import { AppContext } from '@/../script/state/context/AppContext';
import { UnitSuccessBlock } from '@/dom/organism/ims/partials/unit/SuccessBlock';
import { unit2Form } from '@/../script/util/type/unitHelper';
import { API_UNITS } from '@/../script/constant/api';
import { BreadCrumbs } from '@/dom/organism/ims/items/atoms/common/BreadCrumbs'
import { PagePlaceholder } from '@/dom/organism/ims/items/atoms/holders/PagePlaceholder'
...
function Component({
  ...
  ...others
    ...
    {!(newUID != "") &&
    <div className={`ims-body-wide w-100 px-100 h-100vh Q_xs_sm_px-2 flex-col flex-justify-stretch `}>
        <div className="ims-body-inner">
            <BreadCrumbs pages={[["/inventory","Inventory"]]} current={`Add Unit`} />
