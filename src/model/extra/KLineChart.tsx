...
function Component ({ initialArray }:any) {
    ...
    const queryArray:any = useKLine("BTCUSDT", "3m", 11000); // SEC*CANDLE*MILISECONDS
    ...
    return (<>
        <div className="flex-col w-100 pos-rel box-shadow-1 py-2  bord-r-10" style={{background: "linear-gradient(-50deg, #E6EBEC, #ffffff, #E6EBEC)"}}><div className="">
        ...
        <div className="flex w-100 bord-r-10 noverflow mt-4">
            ...
            <div className="noverflow flex-1 flex flex-align-end flex-justify-center box-shadow-i-2 pos-rel">
                <div className="tx-lx pa-5 tx-roman pos-abs pb-2 bottom-0 right-0">Wait</div>
                <div className="tx-lx pa-5 tx-roman pos-abs pb-2 top-0 left-50 ">Watch </div>
                <div className="tx-lx pa-5 tx-roman pos-abs pb-2 bottom-0 left-0"> Act </div>
                <div className="flex-col pos-rel  py-2  ">
                    <div className="bord-r-100p bg-b-50 h-100px w-100px bottom-0 pos-abs translate-y-50"></div>
                    <div className="py-1 bg-b-50 w-80px pos-abs bottom-0" style={{transform:`rotate(${10+(summaryDetails.last10Percent*160/100)}deg)`}}></div>
                </div>
                <div className="flex-col pos-rel  py-2  ">
                    <div className="bord-r-100p bg-b-20 h-300px w-300px bottom-0 pos-abs translate-y-50"></div>
                    <div className="py-1 bg-b-50 w-200px pos-abs bottom-0" style={{transform:`rotate(${10+(summaryDetails.last10Percent*160/100)}deg)`}}></div>
                </div>
                <div className="flex-col pos-rel  py-2  ">
                    <div className="bord-r-100p bg-b-10 h-300px w-500px bottom-0 pos-abs translate-y-50"></div>
                    <div className="pt-1 bg-black w-450px pos-abs bottom-0" style={{transform:`rotate(${10+(summaryDetails.last10Percent*160/100)}deg)`}}></div>
                </div>
            </div>
        </div>
    </>)
